...
import { FlutterDemo } from "@/components/site/FlutterDemo";
...
function Capabilities() {
  ...
  const cap = FLT_CAPABILITIES[active] ?? FLT_CAPABILITIES[0]!;
  return (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
              Five things clients hire our Flutter team for.
            </h2>
          </Reveal>
          <Reveal delay={120}>
...
function BuildIcon({ index }: { index: number }) {
  const shapes = [
    <>
      ...
      <path d="M12 20c0-5 4-8 8-8s8 3 8 8" />
      <path d="M20 14v12M16 18h8" />
    </>,
    <>
    ...
    <>
      <path d="M8 32V14h24v18" />
      <path d="M14 14v-4h12v4" />
      <path d="M16 22h8M16 26h6" />
    </>,
  ];
  return (
    <svg
      ...
      <div className="container-x">
        <Reveal>
          ...
          <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
            What we build in Flutter.
          </h2>
        </Reveal>

        <ul className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FLT_BUILDS.map((b, index) => (
      ...
      <div className="container-x grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
        <Reveal>
          ...
          <p className="mt-5 max-w-sm text-sm leading-relaxed text-muted-foreground">
            ...
            code with it this year.
          </p>
        </Reveal>
        <Reveal delay={100}>
          <ul className="flex flex-wrap gap-2.5">
            {FLT_STACK.map((tool, i) => (
              <li
                key={tool}
    ...
    <section className="relative overflow-hidden bg-navy py-24 text-navy-foreground lg:py-32">
      ...
      <div className="container-x relative">
        <Reveal>
          <p className="eyebrow text-ember">
            <span className="h-px w-8 bg-ember" />
            Hire Flutter app developers · models
          </p>
...
export function FlutterDevPage() {
  return (
    <>
      <Hero />
      <Capabilities />
