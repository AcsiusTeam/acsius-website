...
import { SchoolErpDemo } from "@/components/site/SchoolErpDemo";
...
/* ---------- Modules: ERP-style sidebar explorer (unique to this page) ---------- */
function Modules() {
  const [active, setActive] = useState(1);
  const m = ERP_MODULES[active] ?? ERP_MODULES[0]!;
  return (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
              Eighteen modules. Switch on what your school runs today.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Browse the module list the way your office staff would — pick one to see what it does.
            </p>
          </Reveal>
        </div>
...
function Roles() {
  ...
  const r = ERP_ROLES[active] ?? ERP_ROLES[0]!;
  return (
          ...
          >
            <div className="flex items-center gap-2 border-b border-line bg-mist px-6 py-3.5">
              ...
              <span className="ml-3 text-[11px] font-bold text-muted-foreground">
                {r.label.toLowerCase()} · erp.yourschool.edu.in
              </span>
            </div>
...
/* ---------- Fee flow: horizontal stepper on a wavy spine ---------- */
function FeeFlow() {
  return (
    <section className="relative overflow-hidden py-24 lg:py-32">
      <div className="container-x">
        <Reveal>
          <p className="eyebrow">
            <span className="h-px w-8 bg-ember" />
            School ERP software with online fees
          </p>
          <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
            How a fee reaches your ledger.
          </h2>
        </Reveal>
...
function Deployment() {
  ...
  const d = cloud ? ERP_DEPLOY.cloud : ERP_DEPLOY.onprem;
  return (
    <section className="bg-mist py-24 lg:py-32">
      <div className="container-x grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div>
          <Reveal>
            <p className="eyebrow">
              <span className="h-px w-8 bg-ember" />
              Cloud based school ERP software
            </p>
    ...
    <section className="bg-mist py-24 lg:py-32">
      <div className="container-x">
        <Reveal>
          <p className="eyebrow">
            <span className="h-px w-8 bg-ember" />
            School ERP software for CBSE schools
          </p>
          <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
            Boards and institution types we configure for.
          </h2>
        </Reveal>
    ...
    <section className="py-24 lg:py-32">
      <div className="container-x">
        <Reveal>
          <p className="eyebrow">
            <span className="h-px w-8 bg-ember" />
            Best school ERP software provider in India
          </p>
          <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
            Two kinds of ERP demo. Only one survives term one.
          </h2>
        </Reveal>
          ...
          <Reveal>
            <div className="h-full rounded-[28px] border border-line bg-card p-8 shadow-soft">
              <h3 className="font-display text-xl font-extrabold text-foreground">
                {ERP_COMPARE.typical.title}
              </h3>
              <ul className="mt-6 space-y-4">
                {ERP_COMPARE.typical.points.map((p) => (
          ...
          <Reveal delay={120}>
            <div className="relative h-full overflow-hidden rounded-[28px] bg-navy p-8 text-navy-foreground shadow-lift">
              ...
              <h3 className="relative font-display text-xl font-extrabold text-ember">
                {ERP_COMPARE.acsius.title}
              </h3>
              <ul className="relative mt-6 space-y-4">
                {ERP_COMPARE.acsius.points.map((p) => (
                  <li key={p} className="flex items-start gap-3 text-sm text-navy-foreground/85">
                    <span
                      aria-hidden
                      className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-ember text-[11px] font-black text-primary-foreground"
    ...
    <section id="why" className="bg-mist py-24 lg:py-32">
      <div className="container-x">
        <Reveal>
          ...
          <h2 className="mt-5 max-w-2xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
            An ERP partner your office staff can actually reach.
          </h2>
        </Reveal>
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            <Reveal>
              ...
              <h2 className="mt-5 font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
                School ERP questions, answered straight.
              </h2>
              <p className="mt-5 max-w-sm leading-relaxed text-muted-foreground">
                Still deciding between vendors? Send us your current fee structure and report card
                format — we will show both working in a sandbox.
              </p>
