...
import { AndroidAppDemo } from "@/components/site/AndroidAppDemo";
  ...
  return (
    <section className="relative overflow-hidden bg-navy pt-32 pb-24 text-navy-foreground lg:pt-40 lg:pb-32">
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 55% at 80% 6%, oklch(0.71 0.17 52 / 0.24), transparent 70%), radial-gradient(60% 60% at 6% 22%, oklch(0.62 0.11 250 / 0.36), transparent 70%), radial-gradient(70% 55% at 52% 118%, oklch(0.62 0.11 250 / 0.22), transparent 70%)",
        }}
      />
        ...
        <div>
          ...
          <Reveal delay={280}>
            <div className="mt-9 flex flex-wrap gap-3">
              ...
              >
                Talk to an Android Lead
              </a>
            </div>
          </Reveal>
          <Reveal delay={340}>
            <dl className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-4">
              {AND_HERO.stats.map((stat) => (
                <div key={stat.label}>
          ...
          <div ref={ref} className="relative mx-auto w-full max-w-[480px]">
            ...
            >
              ...
              <div className="grid gap-3 sm:grid-cols-3">
                {[
                  { k: "Build", v: "AAB #86", note: "Signed this sprint" },
                  { k: "Crash-free", v: "99.7%", note: "Gate: 99% minimum" },
                  { k: "Play", v: "1st pass", note: "Your developer account" },
                ].map((row) => (
                  <div
                    key={row.k}
...
/** Signature interaction: Android delivery-track switcher. */
function Tracks() {
  const [active, setActive] = useState(AND_TRACKS[0]!.key);
  const current = AND_TRACKS.find((p) => p.key === active) ?? AND_TRACKS[0]!;
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.2rem]">
              Four tracks inside every Android engagement.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Choose one to see the stack, the platform APIs and what it buys you.
            </p>
          </Reveal>
        </div>
...
const ANSWER_TAGS = ["Stack choice", "Play release", "Ownership", "Takeover"];
        ...
        <div className="mx-auto max-w-2xl text-center">
          <Reveal>
            ...
            <h2 className="mt-5 font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.6rem]">
              Stack, store, ownership.
            </h2>
            <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-foreground">
              Four decisions every app owner has to make, answered without the sales layer.
            </p>
          </Reveal>
          <Reveal delay={120}>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] lg:text-[3.4rem]">
              Idea to Google Play in six phases.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="max-w-xs text-sm leading-relaxed text-navy-foreground/65">
              Every phase ships something you can open, tap or install. No hidden gates.
            </p>
          </Reveal>
        </div>
          ...
          <Reveal delay={120}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <p className="text-sm text-navy-foreground/65">
                Milestone invoicing, weekly installable builds, and your repo from the first commit.
              </p>
            </div>
          </Reveal>
        </div>
...
/** Local intent: "android app developer near me". Deliberately a different layout. */
function LocalStudio() {
  return (
    <section id="near-me" className="bg-mist py-20 lg:py-24">
      <div className="container-x">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-lg font-display text-3xl font-extrabold leading-[1.1] text-foreground lg:text-[2.7rem]">
              {AND_LOCAL.heading}
            </h2>
            ...
            <div className="mt-7 flex flex-wrap gap-2">
              {["New Delhi", "Noida", "Gurugram", "Ghaziabad", "Faridabad", "Remote / global"].map(
                (city) => (
                  <span
                    key={city}
                    className="rounded-full border border-line bg-card px-3.5 py-1.5 text-xs font-bold text-foreground"
                  >
                    {city}
                  </span>
                ),
            ...
            <a href="https://wa.me/919891764802" target="_blank" rel="noopener noreferrer" className="btn-cta mt-8 inline-flex px-7 py-3.5">
              Book a studio or video call
            </a>
          </Reveal>

          <Reveal delay={120}>
            <div className="grid gap-4 sm:grid-cols-2">
              {AND_LOCAL.points.map((p, i) => (
                <div
                  key={p.k}
                  className={`rounded-[26px] border border-line bg-card p-6 shadow-soft transition-all duration-500 hover:-translate-y-1.5 hover:border-primary/30 hover:shadow-lift ${
                    i % 2 ? "sm:mt-6" : ""
                  }`}
                >
                  <p className="text-[10px] font-black uppercase tracking-[0.16em] text-muted-foreground">
                  ...
                  <p className="mt-2 font-display text-xl font-extrabold text-ember">{p.v}</p>
              ...
              <div className="relative">
                ...
                <ul className="mt-7 space-y-3 border-t border-white/12 pt-6 text-sm">
                  {[
                    ...
                    "Google Ads + App campaigns managed monthly",
                    "Install and signup events tracked end to end",
                  ].map((line) => (
      ...
      <div className="container-x">
        <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.4rem]">
              An Android partner you can audit.
            </h2>
          </Reveal>
          <Reveal delay={120}>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-5 rounded-[28px] border border-line bg-card p-6 shadow-soft lg:p-7">
            <div>
              <p className="font-display text-xl font-extrabold text-foreground">
                Send your idea and get a free Android scope call.
              </p>
          ...
          <div className="lg:sticky lg:top-28">
            <Reveal>
              ...
              <h2 className="mt-5 max-w-md font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.4rem]">
                Android app development, answered.
              </h2>
              <p className="mt-5 max-w-sm text-base leading-relaxed text-muted-foreground">
                Send us your idea, a competitor app or your existing repository and we'll tell you
                what we would build and how long it takes.
              </p>
