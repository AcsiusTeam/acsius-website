...
import { IosAppDemo } from "@/components/site/IosAppDemo";
          ...
          <div ref={ref} className="relative mx-auto w-full max-w-[520px]">
            ...
            >
              ...
              <div className="min-w-0 space-y-3">
                {[
                  { k: "Build", v: "TestFlight #31", note: "Shipped this sprint" },
                  { k: "Crash-free", v: "99.8% sessions", note: "Gate: 99% minimum" },
                  { k: "Review", v: "Approved · 1st pass", note: "Under your Apple account" },
                ].map((row) => (
                  <div
                    key={row.k}
...
/** Signature interaction: iOS delivery-track switcher. */
function Tracks() {
  const [active, setActive] = useState(IOS_TRACKS[0]!.key);
  const current = IOS_TRACKS.find((p) => p.key === active) ?? IOS_TRACKS[0]!;
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.2rem]">
              Four tracks inside every iOS engagement.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Choose one to see the Swift stack, the Apple frameworks and what it buys you.
            </p>
          </Reveal>
        </div>
...
const ANSWER_TAGS = ["Platform", "App Review", "Ownership", "Takeover"];
        ...
        <div className="mx-auto max-w-2xl text-center">
          <Reveal>
            ...
            <h2 className="mt-5 font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.6rem]">
              Platform, review, ownership.
            </h2>
            <p className="mx-auto mt-5 max-w-lg text-base leading-relaxed text-muted-foreground">
              Four decisions every iOS product owner has to make, answered without the sales layer.
            </p>
          </Reveal>
          <Reveal delay={120}>
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] lg:text-[3.4rem]">
              Idea to App Store listing in six phases.
            </h2>
          </Reveal>
          <Reveal delay={120}>
          ...
          <Reveal delay={120}>
            <div className="flex flex-wrap items-center gap-4">
              ...
              <p className="text-sm text-navy-foreground/65">
                Milestone invoicing, weekly TestFlight builds, and your repo from the first commit.
              </p>
            </div>
          </Reveal>
        </div>
              ...
              <div className="relative">
                ...
                <ul className="mt-7 space-y-3 border-t border-white/12 pt-6 text-sm">
                  {[
                    ...
                    "Google Ads + Apple Search Ads managed monthly",
                    "Install and lead events tracked end to end",
                  ].map((line) => (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.08] text-navy-foreground lg:text-[3.4rem]">
              Sector-shaped iPhone apps, not a rebadged template.
            </h2>
          </Reveal>
          <Reveal delay={120}>
            <p className="max-w-xs text-sm leading-relaxed text-navy-foreground/65">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-5 rounded-[28px] border border-line bg-card p-6 shadow-soft lg:p-7">
            <div>
              <p className="font-display text-xl font-extrabold text-foreground">
                Send your idea and get a free iOS scope call.
              </p>
          ...
          <div className="lg:sticky lg:top-28">
            <Reveal>
              ...
              <h2 className="mt-5 max-w-md font-display text-4xl font-extrabold leading-[1.08] text-foreground lg:text-[3.4rem]">
                iOS app development, answered.
              </h2>
              <p className="mt-5 max-w-sm text-base leading-relaxed text-muted-foreground">
                Send us your idea, a competitor app or your existing Xcode project and we'll tell you
