...
import { LaravelApiDemo } from "@/components/site/LaravelApiDemo";
...
function Capabilities() {
  ...
  const cap = LRV_CAPABILITIES[active] ?? LRV_CAPABILITIES[0]!;
  return (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <Reveal>
            ...
            <h2 className="mt-5 max-w-3xl font-display text-3xl font-extrabold leading-[1.12] text-foreground lg:text-[2.3rem]">
              Five things clients hire our Laravel team for.
            </h2>
          </Reveal>
          <Reveal delay={120}>
...
export function LaravelDevPage() {
  return (
    <>
      <Hero />
      <Capabilities />
